...
\end{equation}
Así mismo se tendrá que la carga en cada uno de los $n$ capacitores en serie sera la misma, al igual que la carga considerada para el capacitor equivalente, es decir:
\begin{equation}
...
$C_3$ (Caja de Capacitores)& 3 \\ \hline
\end{tabular}
